...
PLOT_PAIR_OPTIONS = {
    ...
    "η vs τ：Viscosity vs shear stress（新增）": ("shear_stress_Pa", "viscosity_Pa_s"),
}
...
with TAB_IMPORT:
    ...
    st.caption("当前版本保留 Herschel–Bulkley (HB)、Cross 和 Ellis，并新增 Fig7：Cross-informed partial yield map。")
        ...
        if not sample_name.strip():
            ...
            try:
                ...
                if run_analysis:
                    ...
                    figs = [res["artifacts"].get(k) for k in ["fig1", "fig2", "fig3", "fig4", "fig5", "fig6", "fig7"]]
                    cols = st.columns(2)
