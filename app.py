...
APP_TITLE = "RheoDB — HB / Cross / Ellis 流变分析"
...
with TAB_IMPORT:
    ...
    st.caption("当前版本仅保留 Herschel–Bulkley (HB)、Cross 和 Ellis 三个模型。")
        ...
        if not sample_name.strip():
            ...
            try:
                ...
                if run_analysis:
                    ...
                    figs = [res["artifacts"].get(k) for k in ["fig1", "fig2", "fig3", "fig4", "fig5", "fig6"]]
                    cols = st.columns(2)
